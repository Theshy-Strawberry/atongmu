						...
						<ul class="list">
							<li class="nojustify">
								<div class="justify-content">
									...
									<input type="hidden" id="activeBouns" name="activeBouns" value="<%=bonusBean.getActiveBouns() %>"/>
								</div>
							</li>
							<li class="nojustify">
								<div class="justify-content">
							...
							<li class="nojustify">
								<div class="justify-content">
									...
									<div class="justify-content">
										<p>
											<button class="button submit block" type="submit">申请提取佣金</button>
										</p>
									</div>
								</div>
							</li>
					...
					<ul class="list">
						<li class="nojustify">
							<div class="justify-content">
								...
								<div class="justify-content">
									<p>
										<button class="button submit block" type="submit">查询该月佣金</button>
									</p>
								</div>
							</div>
						</li>
	...
	<script>
		window.addEventListener("load", function() {
			...
			f.container.addEventListener("submit", function(e) {
			    ...
			    var activeBouns = document.getElementById("activeBouns").value;
			    var regBonus = document.getElementById("regBonus").value;
				if(regBonus > activeBouns){
					var at=new Alert("申请提取的金额不可大于非冻结佣金。");
					at.show();
					returnflg = false;
				}
				if(returnflg == true){
			...
			var f2 = new Form("#form2");
			f2.container.addEventListener("submit", function(e) {
				e.preventDefault();
				var returnflg = f2.validate();
				if(returnflg == true){
					submitForm2();
				}
			}, false);
