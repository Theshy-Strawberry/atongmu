...
<body style="padding-left:2%">
	...
	<div class="body">
		<form id="userslistshow" action="ShowUsersListServlet" method="post" class="form form-horizontal responsive" style="margin-top:15px">
			<label>会员ID：<input type="text" name="usersid" class="input-text" style="width:200px;"></label>
		...
		<table class="table table-border table-bg table-bordered table-hover" style="width:100%;margin-top:15px;">
			<tr>
				<th width="5%" class="text-c" style="background-color:#DFF0D8;">会员ID</th>
				<th width="5%" class="text-c" style="background-color:#DFF0D8;">注册日期</th>
				<th width="5%" class="text-c" style="background-color:#DFF0D8;">会员积分</th>
				<th width="10%" class="text-c" style="background-color:#DFF0D8;">会员姓名</th>
				<th width="5%" class="text-c" style="background-color:#DFF0D8;">会员手机号</th>
				...
				<th width="5%" class="text-c" style="background-color:#DFF0D8;">会员微信号</th>
